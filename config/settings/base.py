...
INFERENCE_HARD_MAX_TOKENS = _env_int("INFERENCE_HARD_MAX_TOKENS", 8092)
...
INFERENCE_MAX_CONCURRENCY = _env_int("INFERENCE_MAX_CONCURRENCY", 4)
INFERENCE_QUEUE_SIZE = _env_int("INFERENCE_QUEUE_SIZE", 10)
INFERENCE_QUEUE_TIMEOUT_S = float(os.environ.get("INFERENCE_QUEUE_TIMEOUT_S", "30.0"))
